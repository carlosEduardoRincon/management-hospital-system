...
public class PacientesController {
    ...
    @Transactional
    public ResponseEntity desativa(@PathVariable("id") Long id) {
    ...
    @PutMapping("/ativa/{id}")
    @Transactional
    public ResponseEntity ativa(@PathVariable("id") Long id) {
        var paciente = repository.getReferenceById(id);
        paciente.ativa();
        return ResponseEntity.noContent().build();
    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity detalhamento(@PathVariable("id") Long id) {
        var paciente = repository.getReferenceById(id);
        return ResponseEntity.ok(new DadosDetalhamentoPaciente(paciente));
    }
}
